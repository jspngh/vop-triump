 ...
 */
public class GroupBeanLoader extends AsyncTaskLoader<GroupBean> {

    private Context context;
    private long groupId;

    public GroupBeanLoader(Context context, long groupId) {
        super(context);
    ...
    public GroupBean loadInBackground() {
        ...
        Log.d("GroupBeanLoader", ""+groupId);
        try{
            result = BackendAPI.get(context).getGroupInfo(groupId);
        } catch(IOException e){
            Log.d("GroupBeanLoader", e.getMessage());
        }
        // Done!
        return result;
    }
