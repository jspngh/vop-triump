...
De applicatie werd uitgebouwd rond 1 centraal scherm vanwaaruit rechtstreeks genavigeerd kan worden naar het Overview-, Checkin- en Groupsscherm. Deze 3 schermen bevatten alle vereiste functies die een reeds gevestigde gebruiker nodig heeft (inchecken, controleren van de evenementen/promoties en groepsactiviteit). Andere functionaliteit (innen van promoties, bekijken van alle groepen en evenementen, instellingen,...) is beschikbaar via het zogenaamd 'navigation drawer' mechanisme. Dit is een paneel met navigeermogelijkheden dat zichtbaar wordt door het vegen naar rechts. De layout van de Android applicatie werd gekozen na analyse van verschillende Android applicaties en huidige ontwikkelstandaarden. Daarnaast wordt een uniforme interface voorzien, conform met de Material Design standaarden.
% Verschillende schermen tonen van applicatie en functionaliteit
% Linken aan doelstelling
%Packagediagram	%Lars
\subsection{Login en tutorial} %Lars
Bij het opstarten van de Android applicatie voor de eerste keer wordt een tutorialsequentie opgestart. Hierin wordt de doelstelling van de applicatie uitgelegd en wat de verschillende mogelijkheden zijn. Indien na feedback van gebruikers blijkt dat deze schermen niet voldoende intuïtief zijn, kan deze tutorial uitgebreid worden met een enkele schermen waarbij de eigelijke applicatie getoond wordt en ingezoomd worden op de specifieke functionaliteit en navigatie doorheen de toepassing. 
...
Na het inloggen wordt op de backend van Triump de gebruiker 'geïnitialiseerd'.
