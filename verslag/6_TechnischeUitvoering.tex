...
\section{Backend}
De backend van Triump steunt op 2 grote onderdelen. Enerzijds is Google Cloud Endpoints als platform voor het bijhouden en verwerken van de data en anderzijds is er de Foursquare API voor de locatiedata.
...
\section{Frontend}
De frontend van Triump op 2 grote onderdelen. Enerzijds is er de Android applicatie, gericht op de gewone gebruikers, en anderzijds is er de webinterface, gericht op geverifieerde gebruikers.
