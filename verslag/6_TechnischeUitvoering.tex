...
\begin{figure}[H]
	...
	\caption{Entity Relation diagram van de backend database. \textsc{opmerking}: Het Boolean type wordt weergegeven als Bit aangezien de community edition van Visual Paradigm, gebruikt voor het opstellen van de ER diagrammen, Booleans niet ondersteunt. }
