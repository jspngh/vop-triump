...
Triump maakt gebruik van App Engine Datastore als backend databank. GAE Datastore verschilt van traditionele relationele databases door zijn specifieke architectuur. De database is namelijk zo ontworpen dat deze automatisch meeschaalt met de toenemende hoeveelheid opgeslagen data. Een tweede verschil is dat er geen automatische controles worden uitgevoerd op de ingevoerde data. Voorbeelden van dergelijke controles zijn: nagaan of een attribuut van een bepaald type is, controleren of een vreemde sleutel bestaat, uniciteit van primaire sleutel garanderen,\ldots. Bijgevolg ligt de verantwoordelijkheid van de integriteit van de database volledig bij de ontwikkelaar. Tijdens de ontwikkeling werd dit gezien als het grootste nadeel van de GAE Datastore tegenover een traditionele relationele database.
